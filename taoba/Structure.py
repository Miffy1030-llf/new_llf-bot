...
class Project:
    def __init__(self, pro_id, title='', starttime = 0, endtime = 0, current=0.0, support_num=0,url=""):
        self.pro_id = pro_id
        self.raise_type = 1
        self.title = title
...
'''
class Record(object):
    def __init__(self, pro_id, user_id, nickname, time, amount=0.0):
        self.pro_id = pro_id
...
class rankingModel(object):
    amount = 0
    plantform_type = ""
    def __init__(self,nickname,pid):
        self.nickname = nickname
        self.pid = pid